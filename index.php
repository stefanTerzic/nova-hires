...
<html>
    ...
    <body>
        ...
        <div class="hero-section d-flex align-items-end segment-start">
            <div class="spinner">
                <div class="parallax-item" data-parallax-multiplier="15">
                    <img src="assets/logo.svg">
                </div>
            </div>

            <div class="hero-image">
                <div class="parallax-item" data-parallax-multiplier="60">
                    <img src="assets/hero-transparent.png">
                </div>
            </div>
            ...
            <div class="container">
                <section>
                    <div class="row">
                        <div class="col col-8 fadein-item" data-animation-delay="1">
                            <h1 class="light">
                        ...
                        <div class="col col-4 fadein-item" data-animation-delay="3">
                            <h5 class="light">
            ...
            <div class="container">
                <section>
                    ...
                    <div class="row block-text-image">
                        <div class="col col-5 col-text fadein-item" data-animation-delay="1">
                            <p class="large">
                    ...
                    <div class="row block-text-image reverse">
                        <div class="col col-7 col-image fadein-item" data-animation-delay="1">
                            <div class="placeholder-image"></div>
                        </div>
                        <div class="col col-5 col-text fadein-item" data-animation-delay="2">
                            <p class="large">
                ...
                <section>
                    <div class="row">
                        <h5 class="large col col-12 fadein-item text-center mb-5" data-animation-delay="1">
                            We provide complete full cycle recruitment services across the US including:
                        </h5>
    
                        <div class="col col-12">
                            <ul class="row block-cards">
                                <li class="col col-2 card">
                                    <div class="card-image fadein-item" data-animation-delay="2"></div>
                                    <p class="fadein-item" data-animation-delay="3">
                                        Advertisement Strategy Creation
                                    </p>
                                </li>
                                <li class="col col-2 card">
                                    <div class="card-image fadein-item" data-animation-delay="4"></div>
                                    <p class="fadein-item" data-animation-delay="5">
                                        Marketing Budget Negotiations
                                    </p>
                                </li>
                                <li class="col col-2 card">
                                    <div class="card-image fadein-item" data-animation-delay="6"></div>
                                    <p class="fadein-item" data-animation-delay="7">
                                        Implementing Hiring Procedures
                                    </p>
                                </li>
                                <li class="col col-2 card">
                                    <div class="card-image fadein-item" data-animation-delay="8"></div>
                                    <p class="fadein-item" data-animation-delay="9">
                                        Optimizing Operation
                                    </p>
                                </li>
                                <li class="col col-2 card">
                                    <div class="card-image fadein-item" data-animation-delay="10"></div>
                                    <p class="fadein-item" data-animation-delay="11">
                                        Lowering Cost-Per-Hire
                                    </p>
                                </li>
                                <li class="col col-2 card">
                                    <div class="card-image fadein-item" data-animation-delay="12"></div>
                                    <p class="fadein-item" data-animation-delay="13">
                ...
                <section>
                    <div class="row block-fullwidth-bg text-center">
                        <div class="bg-element">
                            <div style="background-image: url(./images/group-trucks-parked-row.jpg);"></div>
                        </div>
                        <div class="col col-12">
                            <p class="large light fadein-item" data-animation-delay="1">
                                ...
                                <br>
                                We stand ready to provide the specialized staff you need to keep your business operating smoothly at max capacity. Our knowledgeable and practiced recruiters are here to support you in all employment types! Nova Hires is committed to first-rate quality and service as demonstrated at every level of our agency.
                                <br>
                                Thank you for considering Nova Hires as your recruiting partner! Contact a proven staffing professional today. 
                            </p>
                            <div class="fadein-item" data-animation-delay="2">
                ...
                <section>
                    ...
                    <div class="row block-bordered fadein-item" data-animation-delay="1">
                        <div class="col col-12">
                            <p class="large">
...
testing, behavioral questioning, and situational interviews.
        ...
        <div class="modal-container">
            <div class="block-modal">
                <form action="https://formsubmit.co/stefanterzic94@gmail.com" method="POST">
